    ...
    messages = [
        {
            ...
            "content": (
                ...
                f"{services}\n"
                "REGLAS ESTRICTAS:\n"
                "- Porton, cerca, reja, verja, portones, porton corredizo, porton metalico, estructura metalica, carpinteria metalica, lamas, tubos, alambre de pua -> SIEMPRE servicio 2 (Estructuras Metalicas)\n"
                "- Terraza, techo, azotea, humedad, filtracion, manto, impermeabilizacion -> servicio 7 (Impermeabilizacion)\n"
                "- Muro, fachada, levante, pañete, estuco, pintura, acabado, mamposteria -> servicio 8 (Acabados y Mamposteria)\n"
                "- Redes de agua, alcantarillado, manjoles, tuberias, colectores -> servicio 3 (Redes de Urbanismo) o 4 (Hidraulicas)\n"
                "- Vias, pavimento, adoquin, concreto, subbase -> servicio 6 (Construccion de Vias)\n"
                "- Aire acondicionado, minisplit, climatizacion -> servicio 9 (Mantenimiento A/C)\n"
                "- Planos, diseno, consultoria -> servicio 1 (Consultorias)\n"
